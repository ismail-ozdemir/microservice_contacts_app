...
namespace BuildingBlocks.EventBus.Base.SubManagers
{
    public class InMemoryEventBusSubscriptionManager : IEventBusSubcriptionManager
    {
        ...
        /// <returns></returns>
        public string GetEventKey<TEvent>() where TEvent : IQueueEvent => typeof(TEvent).Name;
        /// <summary>
        ...
        public void AddSubscription<TEvent, TEventHandler>() where TEvent : IQueueEvent where TEventHandler : IQueueEventHandler<TEvent>
        {
        ...
        /// <typeparam name="Event"></typeparam>
        /// <typeparam name="EventHandler"></typeparam>
        public void RemoveSubscription<Event, EventHandler>() where Event : IQueueEvent where EventHandler : IQueueEventHandler<Event>
        {
        ...
        /// <returns></returns>
        public IEnumerable<SubscriptionInfo> GetHandlersForEvent<T>() where T : IQueueEvent
        {
        ...
        /// <param name="eventName"></param>
        /// <returns></returns>
        public bool HasSubcriptionForEvent<T>() where T : IQueueEvent
        {
            string eventName = GetEventKey<T>();
        ...
        private SubscriptionInfo? FindSubsCriptionToRemove<Event, EventHandler>() where Event : IQueueEvent where EventHandler : IQueueEventHandler<Event>
        {
            string eventName = GetEventKey<Event>();
